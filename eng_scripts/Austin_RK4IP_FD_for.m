...
M = 500;                    %iloœæ punktów siatki przestrzennej
...
%print('-f1','Austin_3D_for_FD_500','-dpng')
...
colorbar
%print('-f2','Austin_time_for_FD_500','-dpng')
...
colorbar
%print('-f3','Austin_lambda_for_FD_500','-dpng')
